...
<section id="profil" class="">
    <div class="flex justify-center mb-4 lg:mx-24 mt-4">
        <div class="container mx-4">

            <h1 class="text-2xl md:text-3xl lg:text-4xl font-bold pt-8 text-center lg:text-start uppercase border-b-4 text-black border-orange-500 mb-4">Tentang Yayasan Mentari Sehat Indonesia</h1>
            {{-- <div class="divider divider-warning"></div> --}}
            <div class=" p-2 text-sm lg:text-base text-gray-800 mb-4">
                <p class="">
...
<section id="visi-misi" class="flex flex-row bg-cover bg-center justify-center items-center min-h-screen bg-white" style="">
    {{-- <div class="absolute inset-0 bg-black bg-opacity-50"></div> --}}
    <div class="z-10 flex flex-col-reverse lg:items-center lg:flex-row-reverse lg:mx-24">
        <div class="w-full lg:w-1/2 flex flex-wrap text-center lg:text-start lg:mt-12">
            <div class="w-full mx-4 ">
                <span class="block mt-2 font-bold text-2xl md:text-3xl lg:text-4xl text-black uppercase border-b-4 border-orange-500 p-2 mb-2">Visi Yayasan MSI</span>
...
<section id="" class="flex flex-row bg-cover bg-center justify-center items-center min-h-screen bg-white mb-4" style="">
    {{-- <div class="absolute inset-0 bg-black bg-opacity-50"></div> --}}
    <div class="z-10 flex flex-col-reverse lg:items-center lg:flex-row lg:mx-24">
        <div class="w-full lg:w-1/2 flex flex-wrap lg:mt-12">
            <div class="w-full mx-4 ">
                <span class="block mt-2 font-bold text-2xl md:text-3xl lg:text-4xl text-center lg:text-start text-black uppercase border-b-4 border-orange-500 p-2 mb-2">Misi Yayasan MSI</span>
                {{-- <h2 class="font-medium text-slate-400 mb-5 uppercase">Kabupaten Wonogiri</h2> --}}
