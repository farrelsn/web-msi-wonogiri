...
<div class="flex h-screen w-full items-center justify-center bg-gray-900 bg-cover bg-no-repeat overflow-y-hidden" style="background-image: url('images/profil-msi.jpeg')">
    <div class="rounded-xl bg-gray-800 bg-opacity-50 px-8 py-10 shadow-lg backdrop-blur-md max-sm:px-8">
      <div class="text-white">
        ...
        <form action="{{ route('login.authenticate') }}" method="POST">
          ...
          <div class="mb-4 text-lg">
            <input id="username" name="username" class="rounded-3xl border-none input-md bg-white bg-opacity-50 px-6 py-2 text-inherit placeholder-slate-200 placeholder-opacity-50 shadow-lg outline-none backdrop-blur-md" type="text" name="name" placeholder="Silahkan masukkan email" />
          </div>
